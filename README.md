...
- Casks: `1password`, `visual-studio-code`, `ghostty`, `hammerspoon`, `raycast`, `herd`, `jump-desktop`, `font-jetbrains-mono-nerd-font`, `google-chrome`, `slack`, `todoist-app`, `codex-app`, `elgato-stream-deck`
